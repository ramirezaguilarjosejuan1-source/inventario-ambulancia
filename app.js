...
},
{
  ...
  items:[
    ...
    ["Puntas nasales ped.",3,"num"],
    ["Mascarilla con reservorio",3,"num"],
    ["Mascarilla con reservorio ped.",3,"num"],
    ["Mascarilla simple",3,"num"],
    ["Mascarilla simple ped.",3,"num"],
    ["BVM neonatal",1,"bool"],
...
},
{
  ...
  items:[
    ...
    ["Puntas nasales ped.",2,"num"],
    ["Mascarilla con reservorio",2,"num"],
    ["Mascarilla con reservorio ped.",2,"num"],
    ["Mascarilla simple",2,"num"],
    ["Mascarilla simple ped.",2,"num"],
    ["Normogotero",2,"num"],
